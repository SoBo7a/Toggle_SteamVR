            ...
            try
            {
                if (enable)
                {
                    if (Directory.Exists(disabledSteamVRPath))
                    {
                        ...
                        notifyIcon1.ShowBalloonTip(500, "SteamVR Enabled - v1.0.1", "SteamVR has been enabled.", ToolTipIcon.Info);
                ...
                else
                {
                    if (Directory.Exists(steamVRPath))
                    {
                        ...
                        notifyIcon1.ShowBalloonTip(500, "SteamVR Disabled - v1.0.1", "SteamVR has been disabled.", ToolTipIcon.Info);
