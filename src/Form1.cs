            ...
            try
            {
                if (enable)
                {
                    if (Directory.Exists(disabledSteamVRPath))
                    {
                        ...
                        notifyIcon1.ShowBalloonTip(500, "SteamVR Enabled", "SteamVR has been enabled. - Test", ToolTipIcon.Info);
                ...
                else
                {
                    if (Directory.Exists(steamVRPath))
                    {
                        ...
                        notifyIcon1.ShowBalloonTip(500, "SteamVR Disabled", "SteamVR has been disabled. - Test", ToolTipIcon.Info);
